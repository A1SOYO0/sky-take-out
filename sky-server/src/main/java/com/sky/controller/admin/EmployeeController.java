...
public class EmployeeController {
    ...
    public Result<String> newEmployee(@RequestBody EmployeeDTO employeeDTO) {
        ...
        employeeService.newEmplyee(employeeDTO);
        return Result.success();
    }
    ...
    public Result<PageResult> pageQuery(EmployeePageQueryDTO employeePageQueryDTO) {
        ...
        // 参数校验
        if (employeePageQueryDTO.getPage() < 1) employeePageQueryDTO.setPage(1);
        if (employeePageQueryDTO.getPageSize() < 1) employeePageQueryDTO.setPageSize(10);
